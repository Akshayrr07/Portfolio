...
const SocialLink = ({ platform, href, label }) => {
  ...
  return (
    <motion.a
      ...
      className="group relative flex items-center gap-4 rounded-2xl bg-white/90 dark:bg-[#141414]/90 border border-neutral-200/80 dark:border-neutral-800/90 text-neutral-800 dark:text-neutral-200 hover:text-accent dark:hover:text-accent hover:border-accent/60 shadow-sm dark:shadow-md transition-all duration-300 font-semibold text-sm sm:text-base hover:shadow-[0_0_24px_rgba(37,211,102,0.28)]"
